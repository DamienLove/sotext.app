...
## 2024-05-19 - Unauthenticated GenAI Endpoint
**Vulnerability:** The menuSuggestion GenAI endpoint lacked authentication checks, exposing it to public access.
**Learning:** Unauthenticated AI endpoints can lead to Financial Denial of Service (FDoS) by exhausting API quotas.
**Prevention:** Always verify request.auth is present in onCall handlers exposing GenAI models to prevent unauthorized access and FDoS.
