...
- At the start of a work session (and before wrapping up), open `pulselink.txt` to refresh context and append any notable daily changes so the next session has up-to-date notes.
