package com.pulselink.beacon.notifications
...
import com.pulselink.beacon.data.MessageNotificationPrefs
import com.pulselink.beacon.util.normalizeSmsAddress
...
object MessageNotificationManager {
    ...
    const val EXTRA_THREAD_ID = "com.pulselink.beacon.extra.THREAD_ID"
    const val EXTRA_ADDRESS = "com.pulselink.beacon.extra.ADDRESS"
    ...
    fun notifyIncoming(
        ...
        body: String,
        timestamp: Long,
        settings: MessageNotificationPrefs,
        threadId: Long? = null
    ) {
        if (!areNotificationsEnabled(context)) return

        val normalized = normalizeSmsAddress(address)
        val overrideSound = settings.contactOverrides[normalized]
        val soundUri = overrideSound ?: settings.soundUri
