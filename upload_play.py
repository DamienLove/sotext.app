...
upload_and_release('com.free.pulselink', str(base/'androidApp-free-release-v123.aab'), 123, 'v123')
upload_and_release('com.pulselink.pro', str(base/'androidApp-pro-release-v123.aab'), 123, 'v123')
