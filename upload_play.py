...
upload_and_release('com.free.pulselink', str(base/'androidApp-free-release-v125.aab'), 125, 'v125')
upload_and_release('com.pulselink.pro', str(base/'androidApp-pro-release-v125.aab'), 125, 'v125')
