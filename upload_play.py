...
upload_and_release('com.free.pulselink', str(base/'androidApp-free-release-v124.aab'), 124, 'v124')
upload_and_release('com.pulselink.pro', str(base/'androidApp-pro-release-v124.aab'), 124, 'v124')
