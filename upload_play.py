...
upload_and_release('com.free.pulselink', str(base/'androidApp-free-release-v119.aab'), 119, 'v119')
upload_and_release('com.pulselink.pro', str(base/'androidApp-pro-release-v119.aab'), 119, 'v119')
