...
import com.sotext.R
import com.sotext.data.location.LocationProvider
...
class AlertDispatcher @Inject constructor(
    ...
    private fun buildMessage(phrase: String, tier: EscalationTier, locationText: String?): String {
        ...
        builder.append("\nThis message was sent automatically via SoText.")
