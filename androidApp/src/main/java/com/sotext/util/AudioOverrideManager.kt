...
class AudioOverrideManager @Inject constructor(
    ...
    fun overrideForAlert(
        ...
        val fraction = when (volumeHint) {
            com.sotext.domain.model.VolumeHint.LOW -> 0.35f
            com.sotext.domain.model.VolumeHint.MEDIUM -> 0.6f
            com.sotext.domain.model.VolumeHint.HIGH -> 0.85f
            com.sotext.domain.model.VolumeHint.MAX, null -> 1.0f
        }
