...
class WidgetStateManager @Inject constructor(
    ...
    suspend fun getOnlineFriends(): List<com.sotext.domain.model.Contact> {
        return contactRepository.getAll()
            .filter { it.remotePresence == com.sotext.domain.model.RemotePresence.ONLINE }
            .sortedBy { it.escalationTier } // Prioritize Emergency contacts
            .take(3)
    }

    suspend fun getEmergencyContactsForWidget(): List<com.sotext.domain.model.Contact> {
