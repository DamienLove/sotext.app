...
class AssistantShortcutActivity : FragmentActivity() {
    ...
    /**
     * Extract feature parameter from both deep links (sotext://assistant/{feature})
     * and App Links (https://sotext.app/assistant/{feature})
     *
    ...
    private fun extractDeepLinkFeature(intent: Intent?): String? {
        ...
        // Handle deep links (sotext://assistant/{feature}) — "pulselink" kept as a legacy
        // fallback for any links minted before the app-links host/scheme moved to sotext.
        if (data.scheme == "sotext" || data.scheme == "pulselink") {
        ...
        // Handle App Links (https://sotext.app/assistant/{feature})
    ...
    companion object {
        const val ACTION_ASSISTANT_EMERGENCY = "com.sotext.intent.ASSISTANT_EMERGENCY"
        const val ACTION_ASSISTANT_CHECK_IN = "com.sotext.intent.ASSISTANT_CHECK_IN"
        const val ACTION_ASSISTANT_VOICE = "com.sotext.intent.ASSISTANT_VOICE"
        const val EXTRA_VOICE_QUERY = "com.sotext.extra.VOICE_QUERY"
        ...
        private const val APP_LINKS_HOST = "sotext.app"
    }
}
