...
import com.sotext.util.EmailUtils
                    ...
                    OutlinedButton(
                        onClick = {
                            val shareIntent = Intent(Intent.ACTION_SEND).apply {
                                type = "text/plain"
                                putExtra(Intent.EXTRA_SUBJECT, "Download SoText")
                                putExtra(Intent.EXTRA_TEXT, "Download SoText for Android: https://play.google.com/store/apps/details?id=sotext.app\n\niOS Coming Soon!")
                            }
                            context.startActivity(Intent.createChooser(shareIntent, "Share SoText"))
                        },
