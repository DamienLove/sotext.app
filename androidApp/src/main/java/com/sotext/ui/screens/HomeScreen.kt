...
import com.sotext.ui.ads.NativeAdCard
        ...
        Column(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        text = "Beacon inbox + SoText safety tools are active in this unified view.",
                        style = MaterialTheme.typography.bodySmall,
            ...
            Column {
                ...
                Text(
                    text = if (contactItems.size > 1) {
                        ...
                        "Add contacts to build your SoText support circle."
                    },
                    style = MaterialTheme.typography.bodySmall,
                    color = secondaryText
                )
