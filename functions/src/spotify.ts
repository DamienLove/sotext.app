...
const clientIdSecret = defineSecret("SPOTIFY_CLIENT_ID");
const clientSecretSecret = defineSecret("SPOTIFY_CLIENT_SECRET");
...
export const getSpotifyAccessToken = onCall({
  ...
  // 2. Retrieve secrets using defineSecret() instead of process.env
