# Messaging To Encourage Donations

Reusable copy you can paste into the `README.md`, releases, posts, or the app store listing.
...
```text
Your support funds reliability, accessibility, and iOS development. Thank you! ❤️
```
...
```text
$3/mo: Coffee for build minutes
$10/mo: iOS TestFlight expansion
$25/mo: Device lab + accessibility testing
```

## Impact framing

```text
Every contribution goes directly to reliability, accessibility, and iOS parity. Thank you for helping make safety tools available to more people.
```
...
- Be clear and respectful; explain impact, not pressure.
- Keep accessibility front‑and‑center; mention concrete outcomes.
- Offer multiple support options (time, testing, code, and funding).
