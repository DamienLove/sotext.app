...
*   Add a profile photo (optional but recommended for your contacts).

## 2. Setting Up Your Safety Net

### Adding Trusted Contacts
1.  Go to the **Contacts** tab.
2.  Tap the **(+)** button.
3.  Select a contact from your phone book.
4.  **Choose a Tier**:
    *   **Emergency Contact**: Receives critical sirens (bypasses DND), location, and automated calls.
    *   **Check-In Contact**: Receives status updates and lower-priority notifications.
...
*   **Manual**: Open the app and slide the red **SOS** slider.
*   **What happens**: Your Emergency Contacts will hear a loud siren, receive your location, and get an SMS backup.

### Sending a Check-In
*   Tap the **"I'm Safe"** or **"Check In"** button on the home screen.
*   This sends a silent notification to your contacts with your current location.

### Silent SOS Mode
*   Use this if you are in danger and cannot make noise.
...
*   **AI Assist**:
    *   **Summarize**: Get a summary of busy group chats.
    *   **Magic Compose**: Let AI help you write professional or urgent messages.
*   **Caller ID**: Identify unknown numbers and screen spam.
