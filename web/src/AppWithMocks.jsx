...
function App() {
  const [user, setUser] = useState({ uid: 'mock-user', email: 'mock@example.com' });
  ...
  useEffect(() => {
    ...
    // Mock playlist for verification
    setRingerPlaylist([
        { id: '1', title: 'Test Song 1', artist: 'Test Artist 1', addedAt: Date.now() },
        { id: '2', title: 'Test Song 2', artist: 'Test Artist 2', addedAt: Date.now() }
    ]);
  }, [user]);
  ...
  useEffect(() => {
    // const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
      const currentUser = { uid: 'mock', email: 'mock@example.com' };
      setUser(currentUser);
  ...
  useEffect(() => {
    ...
    // const unsubscribe = onSnapshot(userRef, (snapshot) => {
      ...
      // Force unlock for verification
      setUnlockedAvatars(avatarPresets);
