...
function App() {
  ...
  const combinedThreads = useMemo(() => {
    ...
    // Optimize array allocations by removing flat, map, filter chains and spread operators.
    // This reduces garbage collection overhead and main thread blocking time.
    const lineFiltered = [];
