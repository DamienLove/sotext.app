...
function App() {
  ...
  const combinedThreads = useMemo(() => {
    ...
    // Bolt: Optimized thread combination using imperative loops instead of chained array
    // methods (.flat, .map, .filter) to prevent intermediate array allocations and reduce memory overhead
    const lineFlattened = [];
