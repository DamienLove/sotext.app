...
function App() {
  ...
  const combinedThreads = useMemo(() => {
    ...
    // ⚡ Bolt: Optimize by replacing chained array methods (.flat, .map, .filter)
    // and spread operators with imperative single-pass loops to prevent
    // multiple intermediate array allocations and memory bloat.
    const all = [];
