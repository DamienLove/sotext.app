...
const Sidebar = memo(({
  ...
  const filteredThreads = useMemo(() => {
    ...
    for (const item of getSearchIndex()) {
      if (item && item.searchString && item.searchString.includes(term)) {
...
function App() {
  ...
  const filteredDeviceContacts = useMemo(() => {
    ...
    // and optimize array operations to avoid intermediate allocations
    const results = [];
