...
function App() {
  ...
  const combinedThreads = useMemo(() => {
    ...
    // Bolt: Use imperative loops to prevent intermediate array allocations from
    // .flat(), .map(), and .filter() chains during heavy useMemo re-evaluations.
    const lineFlattened = [];
