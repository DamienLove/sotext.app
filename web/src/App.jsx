...
function App() {
  ...
  const combinedThreads = useMemo(() => {
    ...
    // Bolt: Flatten lineThreads values to lineFlattened accounting for non-arrays
    const lineFlattened = [];
    ...
    // Bolt: Create Set of lineAddresses using a loop
    ...
    // Bolt: Combine and filter in a single pass without spread arrays
    const filtered = [];
