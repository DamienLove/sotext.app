...
function App() {
  ...
  const combinedThreads = useMemo(() => {
    ...
    // ⚡ Bolt Performance Optimization: Replace chained .flat(), .map(), .filter(),
    // and spread operators with single-pass imperative loops to prevent intermediate
    // array allocations during frequent re-renders of large thread lists.
